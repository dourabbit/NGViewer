...
var mouseInputHandler = (function () {
    // private static
    //var nextId = 1;
    var threshold = 3;
    ...
    var cls = function (canvas, fncList) {
        ...
        this.handleMouseDown = function (event) {
            ...
            if (!curEvent)
                curEvent = new Object();
            curEvent = { MousePosX: event.clientX, MousePosY: event.clientY, Event: "MouseDown",Button: event.button };
        ...
        this.handleMouseUp = function (event) {
            ...
            if (!curEvent)
                curEvent = new Object();
            curEvent = { MousePosX: event.clientX, MousePosY: event.clientY, Event: "MouseUp", Button: event.button };
            objectPool.push(curEvent);
        ...
        this.handleMouseMove = function (event) {
            ...
            curEvent = { MousePosX: event.clientX, MousePosY: event.clientY, Event: "MouseMove", Button: event.button };
            objectPool.push(curEvent);
            for (var i = 0; i < fncList.length; i++)
                fncList[i].call(InputHelper, objectPool);
