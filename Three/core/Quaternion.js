 ...
 */
Math3D.Quaternion = function( x, y, z, w ) {
...
Math3D.Quaternion.multiplyVec3 = function ( quat, vec ) {
			var result = vec;
...
Math3D.Quaternion.multiplyQuat = function ( quat1,quat2 ) {

	var qax = quat1.x,  qay = quat1.y,  qaz = quat1.z,  qaw = quat1.w,
	qbx = quat2.x, qby = quat2.y, qbz = quat2.z, qbw = quat2.w;

	quat1.x = qax * qbw + qaw * qbx + qay * qbz - qaz * qby;
	quat1.y = qay * qbw + qaw * qby + qaz * qbx - qax * qbz;
	quat1.z = qaz * qbw + qaw * qbz + qax * qby - qay * qbx;
	quat1.w = qaw * qbw - qax * qbx - qay * qby - qaz * qbz;

	return quat1;

};
Math3D.Quaternion.prototype = {

	constructor: Math3D.Quaternion,
	...
	clone: function () {
		...
		return new Math3D.Quaternion( this.x, this.y, this.z, this.w );
...
Math3D.Quaternion.slerp = function ( qa, qb, qm, t ) {
