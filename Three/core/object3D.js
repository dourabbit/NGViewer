...
var object3D = function () {
    ...
    this._rotMat = new Matrix4();
    this._scaleMat = new Matrix4();
...
object3D.prototype ={
	...
	update:function(){
		//var posMat = new Matrix4();
		//posMat.setPosition( this._position );
		this.mMatrix.setPosition( this._position );
		this.mMatrix.setRotationFromQuaternion( this._quaternion );
		//this.mMatrix = new Matrix4();
		//this.mMatrix = Matrix4.multiply(posMat,this.mMatrix);
