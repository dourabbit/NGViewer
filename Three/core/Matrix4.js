...
Math3D.Matrix4 = function ( n11, n12, n13, n14, n21, n22, n23, n24, n31, n32, n33, n34, n41, n42, n43, n44 ) {
...
Math3D.Matrix4.rotateVector3 = function ( m,v ) {
...
Math3D.Matrix4.multiply = function ( a, b ) {
	var result = new Math3D.Matrix4();
	...
	result.n11 = a11 * b11 + a12 * b21 + a13 * b31 + a14 * b41;
	result.n12 = a11 * b12 + a12 * b22 + a13 * b32 + a14 * b42;
	result.n13 = a11 * b13 + a12 * b23 + a13 * b33 + a14 * b43;
	result.n14 = a11 * b14 + a12 * b24 + a13 * b34 + a14 * b44;

	result.n21 = a21 * b11 + a22 * b21 + a23 * b31 + a24 * b41;
	result.n22 = a21 * b12 + a22 * b22 + a23 * b32 + a24 * b42;
	result.n23 = a21 * b13 + a22 * b23 + a23 * b33 + a24 * b43;
	result.n24 = a21 * b14 + a22 * b24 + a23 * b34 + a24 * b44;

	result.n31 = a31 * b11 + a32 * b21 + a33 * b31 + a34 * b41;
	result.n32 = a31 * b12 + a32 * b22 + a33 * b32 + a34 * b42;
	result.n33 = a31 * b13 + a32 * b23 + a33 * b33 + a34 * b43;
	result.n34 = a31 * b14 + a32 * b24 + a33 * b34 + a34 * b44;

	result.n41 = a41 * b11 + a42 * b21 + a43 * b31 + a44 * b41;
	result.n42 = a41 * b12 + a42 * b22 + a43 * b32 + a44 * b42;
	result.n43 = a41 * b13 + a42 * b23 + a43 * b33 + a44 * b43;
	result.n44 = a41 * b14 + a42 * b24 + a43 * b34 + a44 * b44;

	return result;

};
Math3D.Matrix4.prototype = {

	constructor: Math3D.Matrix4,
	...
	lookAt: function ( eye, target, up ) {
		...
		var x = Math3D.Matrix4.__v1, y = Math3D.Matrix4.__v2, z = Math3D.Matrix4.__v3;
		...
		this.n11 = x.x; this.n12 = y.x; this.n13 = z.x;this.n14 =-(x.x*eye.x + y.x*eye.y + z.x*eye.z);
		this.n21 = x.y; this.n22 = y.y; this.n23 = z.y;this.n24 =-(x.y*eye.x + y.y*eye.y + z.y*eye.z);
		this.n31 = x.z; this.n32 = y.z; this.n33 = z.z;this.n34 =-(x.z*eye.x + y.z*eye.y + z.z*eye.z);

//		this.n11 = x.x; this.n12 = x.y; this.n13 = x.z;
//		this.n21 = y.x; this.n22 = y.y; this.n23 = y.z;
//		this.n31 = z.x; this.n32 = z.y; this.n33 = z.z;
	...
	rotateVecX: function (target, up, transLocal) {

		var x = target.normalize(), y = Math3D.Matrix4.__v2, z = Math3D.Matrix4.__v3;
		...
		this.n11 = x.x; this.n12 = y.x; this.n13 = z.x;this.n14 =(x.x*transLocal.x + y.x*transLocal.y + z.x*transLocal.z);
		this.n21 = x.y; this.n22 = y.y; this.n23 = z.y;this.n24 =(x.y*transLocal.x + y.y*transLocal.y + z.y*transLocal.z);
		this.n31 = x.z; this.n32 = y.z; this.n33 = z.z;this.n34 =(x.z*transLocal.x + y.z*transLocal.y + z.z*transLocal.z);
...
//		flat[ 0 ] = this.n11;flat[ 1 ] = this.n12;flat[ 2 ] = this.n13;flat[ 3 ] = this.n14;
//		flat[ 4 ] = this.n21;flat[ 5 ] = this.n22;flat[ 6 ] = this.n23;flat[ 7 ] = this.n24;
//		flat[ 8 ] = this.n31;flat[ 9 ] = this.n32;flat[ 10 ] = this.n33;flat[ 11 ] = this.n34;
//		flat[ 12 ] = this.n41;flat[ 13 ] = this.n42;flat[ 14 ] = this.n43;flat[ 15 ] = this.n44;
		return flat;
	...
	getPosition: function () {
		...
		return Math3D.Matrix4.__v1.set( this.n14, this.n24, this.n34 );

	},

	getColumnX: function () {

		return Math3D.Matrix4.__v1.set( this.n11, this.n21, this.n31 );

	},

	getColumnY: function () {

		return Math3D.Matrix4.__v1.set( this.n12, this.n22, this.n32 );

	},

	getColumnZ: function() {

		return Math3D.Matrix4.__v1.set( this.n13, this.n23, this.n33 );
	...
	compose: function ( translation, rotation, scale ) {
		...
		var mRotation = Math3D.Matrix4.__m1;
		var mScale = Math3D.Matrix4.__m2;
	...
	decompose: function ( translation, rotation, scale ) {
		...
		var x = Math3D.Matrix4.__v1;
		var y = Math3D.Matrix4.__v2;
		var z = Math3D.Matrix4.__v3;
		...
		var matrix = Math3D.Matrix4.__m1;
	...
	extractRotation: function ( m ) {
		...
		var vector = Math3D.Matrix4.__v1;
...
Math3D.Matrix4.makeInvert3x3 = function ( m1 ) {

	// input:  Math3D.Matrix4, output: Matrix3
...
Math3D.Matrix4.makeFrustum = function ( left, right, bottom, top, near, far ) {

	var m, x, y, a, b, c, d;

	m = new Math3D.Matrix4();
...
Math3D.Matrix4.makePerspective = function ( fov, aspect, near, far ) {
	...
	return Math3D.Matrix4.makeFrustum( xmin, xmax, ymin, ymax, near, far );

};

Math3D.Matrix4.makeOrtho = function ( left, right, top, bottom, near, far ) {
...
Math3D.Matrix4.__v1 = new Math3D.Vector3();
Math3D.Matrix4.__v2 = new Math3D.Vector3();
Math3D.Matrix4.__v3 = new Math3D.Vector3();

Math3D.Matrix4.__m1 = new Math3D.Matrix4();
Math3D.Matrix4.__m2 = new Math3D.Matrix4();
