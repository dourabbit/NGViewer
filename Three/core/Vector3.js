...
Math3D.Vector3.add = function ( v1, v2 ) {
	var result = new Math3D.Vector3();
	result.x = v1.x + v2.x;
	result.y = v1.y + v2.y;
	result.z = v1.z + v2.z;
...
Math3D.Vector3.multiplyScalar = function ( v1, a ) {
	var result = new Math3D.Vector3();
	result.x = v1.x*a;
	result.y = v1.y*a;
	result.z = v1.z*a;
...
Math3D.Vector3.prototype = {

	constructor: Math3D.Vector3,
	...
	clone: function () {
		...
		return new NGViewer.Math.Math.Vector3( this.x, this.y, this.z );
	...
	distanceToSquared: function ( v ) {
		...
		return new NGViewer.Math.Math.Vector3().sub( this, v ).lengthSq();
	...
	*/
	...
	flattenToArray: function ( flat ) {
		...
		flat[ 0 ] = this.x; flat[ 1 ] = this.y; flat[ 2 ] = this.z;
		return flat;
